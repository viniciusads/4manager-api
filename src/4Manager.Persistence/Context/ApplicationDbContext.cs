    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserProfile>(entity =>
            {
                ...
                entity.Property(u => u.Function).IsRequired();
            });
            ...
            modelBuilder.Entity<ActivityType>(entity =>
            {
                ...
                entity.HasKey(a => a.ActivityTypeId);

                entity.Property(a => a.ActivityTypeId)
                      .HasDefaultValueSql("gen_random_uuid()");
            });
            ...
            {
                entity.ToTable("scheduleTasks");
                entity.HasKey(s => s.ScheduleTaskId);
                entity.Property(s => s.ScheduleTaskId)
                      .HasDefaultValueSql("gen_random_uuid()");

                entity.Property(s => s.TaskType)
                        .IsRequired();
                ...
                entity.Property(s => s.Stakeholder)
                        .HasMaxLength(200);

                entity.Property(s => s.CompletionPercentage)
                        .HasPrecision(5, 2);
                entity.Property(s => s.OrderIndex)
                        .IsRequired();
