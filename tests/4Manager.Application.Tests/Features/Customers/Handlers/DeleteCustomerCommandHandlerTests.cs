...
namespace _4Tech._4Manager.Application.Tests.Features.Customers.Handlers
{
    public class DeleteCustomerCommandHandlerTests
    {
        ...
        [Fact]
        public async Task Handle_Should_Delete_Customer_And_Return_Dto()
        {
            ...
            mockRepo.Setup(r => r.DeleteCustomerAsync(customerId, It.IsAny<CancellationToken>()))
                .Returns(Task.CompletedTask);

            var command = new DeleteCustomerCommand(customerId);
            var handler = new DeleteCustomerCommandHandler(mockRepo.Object, _mapper);
            ...
            mockRepo.Verify(r => r.DeleteCustomerAsync(customerId, It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task Handle_Should_Throw_Exception_When_Customer_Not_Found()
        {
            ...
            mockRepo.Verify(r => r.GetByIdAsync(customerId, It.IsAny<CancellationToken>()), Times.Once);
            mockRepo.Verify(r => r.DeleteCustomerAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()), Times.Never);
        }
    }
}
